import{bv as U,bw as I,bx as y,by as i,bz as r,bA as k,bB as C,bC as u,bD as T,bE as h,bF as x,ad as L,aa as K,bG as O,bH as R,bI as z,bJ as P,bK as p,af as $,bL as M}from"./index-xKo9LRLe.js";const W=U`
  :host {
...
`;var l=function(m,e,t,a){var o=arguments.length,s=o<3?e:a===null?a=Object.getOwnPropertyDescriptor(e,t):a,d;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")s=Reflect.decorate(m,e,t,a);else for(var c=m.length-1;c>=0;c--)(d=m[c])&&(s=(o<3?d(s):o>3?d(e,t,s):d(e,t))||s);return o>3&&s&&Object.defineProperty(e,t,s),s};const N="scroll-lock";let n=class extends I{constructor(){super(),this.unsubscribe=[],this.abortController=void 0,this.hasPrefetched=!1,this.enableEmbedded=y.state.enableEmbedded,this.open=i.state.open,this.caipAddress=r.state.activeCaipAddress,this.caipNetwork=r.state.activeCaipNetwork,this.shake=i.state.shake,this.initializeTheming(),k.prefetchAnalyticsConfig(),this.unsubscribe.push(i.subscribeKey("open",e=>e?this.onOpen():this.onClose()),i.subscribeKey("shake",e=>this.shake=e),r.subscribeKey("activeCaipNetwork",e=>this.onNewNetwork(e)),r.subscribeKey("activeCaipAddress",e=>this.onNewAddress(e)),y.subscribeKey("enableEmbedded",e=>this.enableEmbedded=e))}firstUpdated(){var e,t;if(C.fetchNetworkImage((t=(e=this.caipNetwork)==null?void 0:e.assets)==null?void 0:t.imageId),this.caipAddress){if(this.enableEmbedded){i.close(),this.prefetch();return}this.onNewAddress(this.caipAddress)}this.open&&this.onOpen(),this.enableEmbedded&&this.prefetch()}disconnectedCallback(){this.unsubscribe.forEach(e=>e()),this.onRemoveKeyboardListener()}render(){return this.style.cssText=`
    ...
    </wui-card>`}async onOverlayClick(e){e.target===e.currentTarget&&await this.handleClose()}async handleClose(){h.state.view==="UnsupportedChain"||await x.isSIWXCloseDisabled()?i.shake():i.close()}initializeTheming(){const{themeVariables:e,themeMode:t}=M.state,a=L.getColorTheme(t);K(e,a)}onClose(){this.open=!1,this.classList.remove("open"),this.onScrollUnlock(),O.hide(),this.onRemoveKeyboardListener()}onOpen(){this.prefetch(),this.open=!0,this.classList.add("open"),this.onScrollLock(),this.onAddKeyboardListener()}onScrollLock(){const e=document.createElement("style");e.dataset.w3m=N,e.textContent=`
      body {
        touch-action: none;
        overflow: hidden;
    ...
    `,document.head.appendChild(e)}onScrollUnlock(){const e=document.head.querySelector(`style[data-w3m="${N}"]`);e&&e.remove()}onAddKeyboardListener(){var t;this.abortController=new AbortController;const e=(t=this.shadowRoot)==null?void 0:t.querySelector("wui-card");e==null||e.focus(),window.addEventListener("keydown",a=>{if(a.key==="Escape")this.handleClose();else if(a.key==="Tab"){const{tagName:o}=a.target;o&&!o.includes("W3M-")&&!o.includes("WUI-")&&(e==null||e.focus())}},this.abortController)}onRemoveKeyboardListener(){var e;(e=this.abortController)==null||e.abort(),this.abortController=void 0}async onNewAddress(e){const t=r.state.isSwitchingNamespace,a=R.getPlainAddress(e);!a&&!t?i.close():t&&a&&h.goBack(),await x.initializeIfEnabled(),this.caipAddress=e,r.setIsSwitchingNamespace(!1)}onNewNetwork(e){var w,b,f,g,v;C.fetchNetworkImage((w=e==null?void 0:e.assets)==null?void 0:w.imageId);const t=(f=(b=this.caipNetwork)==null?void 0:b.caipNetworkId)==null?void 0:f.toString(),a=(g=e==null?void 0:e.caipNetworkId)==null?void 0:g.toString(),o=t&&a&&t!==a,s=r.state.isSwitchingNamespace,d=((v=this.caipNetwork)==null?void 0:v.name)===z.UNSUPPORTED_NETWORK_NAME,c=h.state.view==="ConnectingExternal",S=!this.caipAddress,E=o&&!d&&!s,A=h.state.view==="UnsupportedChain";!c&&(S||A||E)&&h.goBack(),this.caipNetwork=e}prefetch(){this.hasPrefetched||(this.hasPrefetched=!0,k.prefetch())}};n.styles=W;l([P({type:Boolean})],n.prototype,"enableEmbedded",void 0);l([p()],n.prototype,"open",void 0);l([p()],n.prototype,"caipAddress",void 0);l([p()],n.prototype,"caipNetwork",void 0);l([p()],n.prototype,"shake",void 0);n=l([$("w3m-modal")],n);export{n as W3mModal};
